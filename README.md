...
Scripts and notebooks to produce advanced PZ data products in the context of [BRA-LIN-S4 in-kind program](https://linea-it.github.io/pz-lsst-inkind-doc/). 


--- 

## Setup Conda Environment and Kernel Configuration for Open OnDemand (LIneA) - Data Preparation Scripts
